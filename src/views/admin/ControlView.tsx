  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {list.length === 0 ? (
        ...
        <>
          {/* Mobile: Turn pills */}
          <div className="md:hidden flex gap-2 overflow-x-auto px-5 py-3 border-b border-border">
            {list.map((t) => (
          ...
          <div className="flex-1 hidden md:flex min-h-0">
            {/* Sidebar */}
            <div className="flex flex-col w-64 border-r border-border bg-surface/50">
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center gap-3 min-w-0">
                              ...
                              <span className="text-text-hi text-sm font-medium truncate">{al.nombre}</span>
                            </div>
                            <div
                              className={`flex items-center justify-center rounded-full transition-all w-7 h-7 shrink-0 ${
                                present
          ...
          {/* Mobile: Asistencia list */}
          <div className="flex-1 flex flex-col min-h-0 md:hidden">
            {selected && (
              <>
                <div className="px-5 py-4 flex items-center justify-between border-b border-border">
                  <div>
                    <span className="font-display text-text-hi text-lg tracking-wide">
                      {selected.actividad}
                    </span>
